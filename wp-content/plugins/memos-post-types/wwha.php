<?php
/*
Plugin Name: MEMOS What we have achieved
Description: What we have achieved post type for WordPress 3.0 and above.
...
class Wwha {
	...
	function Wwha()
	{
		...
		register_post_type($this->name, array(
			...
			'hierarchical' => false,
			'rewrite' => array("slug" => "what-we-have-achieved"), // Permalinks
			'query_var' =>$this->name, // This goes to the WP_Query schema
			'labels' => array(	'name' => __( 'What we have achieved' ),
						'singular_name' => __( 'What we have achieved' ),
						'add_new' => __( 'Add New' ),
						'add_new_item' => __( 'Add New What we have achieved' ),
						'edit' => __( 'Edit' ),
						'edit_item' => __( 'Edit What we have achieved' ),
						'new_item' => __( 'New What we have achieved' ),
						'view' => __( 'View What we have achieved' ),
						'view_item' => __( 'View What we have achieved' ),
						'search_items' => __( 'Search What we have achieved' ),
						'not_found' => __( 'No What we have achieved found' ),
						'not_found_in_trash' => __( 'No What we have achieved found in Trash' ),
						'parent' => __( 'Parent What we have achieved' )
					 ),
...
// Initiate the plugin
add_action("init", "WwhaInit");
function WwhaInit() { global $memWwha; $memWwha = new Wwha(); }