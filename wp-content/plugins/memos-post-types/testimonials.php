<?php
/*
Plugin Name: MEMOS Testimonials
Description: Testimonials post type for WordPress 3.0 and above.
...
function TestimonialsInit() { global $memTestimonials; $memTestimonials = new Testimonials(); }